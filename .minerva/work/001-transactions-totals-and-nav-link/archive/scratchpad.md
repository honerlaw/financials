...
- [FIXED]  #1 low  tests/test_routes.py — pin zero-txn account still rendering in strip (Approach §5)
- [IGNORED] #2 low app/sync.py::_to_decimal — bare except acceptable for single-user / Plaid SDK
- [IGNORED] #3 low app/templates/index.html — "0 txns" plural is conventional
