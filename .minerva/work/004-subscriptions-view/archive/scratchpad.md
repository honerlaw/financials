...
- [1/3 accept → revised → 2/2 accept round 2] promote partition: split testing note into its own pattern entry (004), promote detection-gate shape as durable with constants marked provisional, rescue no-bimonthly note into Open Questions
- [skipped — small] TODO disposition: single unambiguous item → followups.md (evidence: one forward-looking conditional finding, matching the followups.md precedent in work unit 003)
...
- [synthesis] wrote first overview.md (watermark -1→004; 4 entries synthesized, 3 themes)
